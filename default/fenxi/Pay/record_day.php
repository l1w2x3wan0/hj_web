...
if ($result){
	...
	$sql = "select * from log_game_record_log_".date("Ym")." where curtime>='$time1' and curtime<'$time2' $sql1 limit 0,5000";
...
if ($result){
	...
	$sql = "select * from log_gold_change_log_".date("Ym")." where curtime>='$time1' and curtime<'$time2' $sql1 limit 0,5000";
	$res = mysql_query($sql, $conn2);
	while ($row = mysql_fetch_array($res)){
...
if ($result){
	...
	$sql = "select * from login_log_".date("Ym")." where login_date>='$date1' and login_date<'$date2' $sql1 limit 0,5000";
	$res = mysql_query($sql, $conn2);
	while ($row = mysql_fetch_array($res)){
