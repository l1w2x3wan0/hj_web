...
mysql_query("SET NAMES utf8");
	...
	for ($key=0; $key<10; $key++){
		...
		$small_img =  "http://api.pic.kk520.com:9101/work/small/".$userinfo['head_picture'].".jpg";
		$big_img =  "http://api.pic.kk520.com:9101/work/".$userinfo['head_picture'].".jpg";
		...
		$user[$next]['tx'] = !empty($userinfo['head_picture']) ? $img : 0;
