<?php if (!defined('THINK_PATH')) exit();?>﻿<html>
 ...
 <body>
  <div id="wrapper">
   <p class="msg-title" style="font-size:20px;"><?php echo ($msgTitle); ?></p>
   <?php if(isset($message)): ?><p class="message" style="font-size:20px;"><?php echo ($message); ?></p><?php endif; ?>
   <?php if(isset($error)): ?><p class="error" style="font-size:20px;"><?php echo ($error); ?></p><?php endif; ?>
   <?php if(isset($closeWin)): ?><p class="notice"><b>系统将在</b> <span style="color:blue;font-weight:bold"><b id="wait"><?php echo($waitSecond); ?></b></span> 秒后自动关闭，如果不想等待,直接点击 <a id="href" href="<?php echo($jumpUrl); ?>">这里</a> 关闭</p><?php endif; ?>
   <?php if(!isset($closeWin)): ?><p class="notice"><b>系统将在</b> <span style="color:blue;font-weight:bold"><b id="wait"><?php echo($waitSecond); ?></b></span> 秒后自动跳转，如果不想等待,直接点击 <a id="href" href="<?php echo($jumpUrl); ?>">这里</a> 关闭</p><?php endif; ?>
  </div>
 </body>
</html>
