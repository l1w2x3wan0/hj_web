...
function testOrder() {
    ...
    $orderReq['waresid'] = 1;
    $orderReq['cporderid'] = '1xdxd12311234121234123dxdxd'; //确保该参数每次 都不一样。否则下单会出问题。
...
function H5orPCpay() {
	...
	$orderReq['redirecturl'] = 'http://58.250.160.241:8888/IapppayCpSyncForPHPDemo/Test.php';
	$orderReq['cpurl'] = 'http://1.1.1.1:8888/IapppayCpSyncForPHPDemo/Test.php';
	//组装请求报文   对数据签名
	$reqData = composeReq($orderReq, $appkey);
