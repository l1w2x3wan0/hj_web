...
$url = "http://pay.kk520.com:9102/index.php?m=Payinter&a=get_order_zjh&date=".$getdate;
$result = curlGET($url);
if (!empty($result)){
	...
	$url = "http://pay.kk520.com:9102/index.php?m=Payinter&a=post_order_zjh&date=".$getdate;
	$result = curlGET($url);
	echo $result;
}
